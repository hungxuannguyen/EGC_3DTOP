%% This code derived from [Van-Nam Hoang, H. Nguyen-Xuan, Extruded-geometric-component-based 3D topology optimization
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This MatLab code was written by Dr Van-Nam Hoang,                      
% Mechanical Engineering Institute, Vietnam Maritime University, Vietnam, 
% Contact: namhv.vck@vimaru.edu.vn,
